...
namespace SharedDriver
{
    public abstract class AnalyzerDriverBase : IDisposable
    {
        ...
        public virtual bool IsPreviewing { get { return false; } }
        #endregion

        #region Events
        public abstract event EventHandler<CaptureEventArgs>? CaptureCompleted;
        public virtual event EventHandler<PreviewEventArgs>? PreviewDataReceived;
        #endregion
        ...
        public virtual bool StartRealtimePreview(AnalyzerChannel[] channels, int intervalsPerSecond, int samplesPerInterval)
        {
            return false;
        }
        public virtual bool StopRealtimePreview()
        {
            return false;
        }
        #endregion
        ...
        public virtual bool SendNetworkConfig(string AccesPointName, string Password, string IPAddress, ushort Port, string Hostname = "")
        {
            return false;
        }
        #endregion
        ...
        [StructLayout(LayoutKind.Sequential)]
        protected struct PreviewRequest
        {
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)]
            public byte[] channels;
            public UInt32 intervalUs;
            public byte channelCount;
            public byte samplesPerInterval;
        }
